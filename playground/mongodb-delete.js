...
// db.collection('TodoApp').deleteMany({text:'Karthik'}).then((results)=>{
//   console.log(results);
// });

// db.collection('TodoApp').deleteOne({name:'Karthik'}).then((results)=>{
//   console.log(results);
// });
//
// db.collection('TodoApp').findOneAndDelete({completedAt: false}).then((results)=>{
//   console.log(results);
// });

db.collection('Users').deleteMany({name:'Karthik'}).then((res)=>{
  console.log(res);
} , (err)=>{
  console.log(err);
});
